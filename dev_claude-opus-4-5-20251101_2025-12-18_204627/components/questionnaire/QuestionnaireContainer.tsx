...
export default function QuestionnaireContainer({
  ...
  }, [responses, currentQuestionIndex, currentModuleIndex, streak, combo, shownMilestones, isDataLoaded]);
  ...
  // Helper to check if a value is a valid answer
  const isValidAnswer = useCallback((value: unknown): boolean => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sand-50 via-white to-sand-100 flex items-center justify-center">
        <div className="glass rounded-3xl p-12 shadow-premium text-center">
          <div className="animate-spin w-12 h-12 border-4 border-gold border-t-transparent rounded-full mx-auto mb-6" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1 text-center hidden md:block">
              <span className="text-2xl mr-2">{currentModule?.icon}</span>
            ...
            <div className="flex items-center gap-4">
              {streak > 0 && (
                <div className={cn(
                  "relative flex flex-col items-center px-4 py-2 rounded-2xl text-sm font-medium transition-all duration-300",
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[9px] text-amber-700 font-semibold uppercase tracking-wide">
                        streak
                      </span>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="lg:hidden mb-6 glass rounded-xl p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{currentModule?.subtitle}</p>
              </div>
            </div>
