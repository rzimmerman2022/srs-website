...
export default function ModuleNav({
  ...
  return (
    <nav className="glass rounded-xl lg:rounded-2xl p-3 lg:p-4 shadow-premium" aria-label="Questionnaire sections">
      <h3 className="text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider mb-3 lg:mb-4 px-2">
        Sections
      </h3>
