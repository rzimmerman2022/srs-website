...
| Tier | Scope | Controls |
|------|-------|----------|
| T0 (Low) | Docs, comments, non-prod | Builder only |
| T1 (Medium) | Non-core features, UI | Builder → Adversarial Review |
| T2 (High) | Core logic, auth, pipelines | Builder → Verification Agent → Lens Review |
| T3 (Critical) | Security, billing, PII, regulatory | **Differential Model Gate** (see below) |
...
| Version | 2.1 |
| Created | 2025-12-26 |
| Changelog | Schema expansion (12 cols), Status/QA separation, Rev tracking, QA isolation constraint, T2/T3 gate |

---

*Platinum Standard v2.1: Maximum compliance, minimum overhead, zero ambiguity.*
