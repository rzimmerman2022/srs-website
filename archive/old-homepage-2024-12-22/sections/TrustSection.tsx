...
/**
 * Trust Section Icons
 * Per Fortune 500 specs: LG badges use 24-28px icons (w-7 h-7)
 * Metric badges use 32-48px icons (w-8 h-8 to w-12 h-12)
 */

// Icons for Trust Badges (LG size = 24-28px)
const IconStar = () => (
...
// Icons for Metric Badges (32-48px)
...
export default function TrustSection() {
  return (
    <section className="py-12 md:py-16 bg-white border-b border-sand-100">
      <Container>
        {/* Section Header - Fortune 500 styling */}
        ...
        {/* Metrics Row - Fortune 500 visual impact */}
        ...
        <p className="text-center text-sm text-charcoal/80 mt-8 max-w-xl mx-auto">
